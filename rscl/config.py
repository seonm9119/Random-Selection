...
MODEL_NAME = "RSCL"
MODEL_FULL_NAME = "Random Selection Contrastive Learning"
PAPER_SETTING_SOURCE = "2022_KCC_Random_Selection_based_Loss_Function"
BASELINE_REFERENCE = "A Simple Framework for Contrastive Learning of Visual Representations"
...
def get_training_config():
    return {
        ...
        "baseline_paper_url": BASELINE_PAPER_URL,
        "baseline_official_github": BASELINE_OFFICIAL_GITHUB,
        "dataset": DATASET,
        ...
        "projection_hidden_dim": PROJECTION_HIDDEN_DIMS[BACKBONE_NAME],
